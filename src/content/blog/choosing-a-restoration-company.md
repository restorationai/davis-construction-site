...
generated_at: "2026-05-21T22:58:01.906136+00:00"
...
faq: [{"question": "How do I know if a restoration contractor is properly licensed and insured?", "answer": "In Alabama, contractors performing structural repairs must be licensed through the Alabama Licensing Board for General Contractors, and licenses can be verified through the board's public lookup. Ask the company for its license number and a current certificate of insurance \u2014 a reputable contractor will provide both without hesitation. If they can't, treat their claims as unverified."}, {"question": "Can I do my own water damage cleanup to save money before calling a professional?", "answer": "You can and should stop the source of water immediately and remove standing water if it's safe to do so \u2014 that limits the damage. However, surface drying with fans and towels rarely addresses moisture that has wicked into wall cavities, subfloor, or insulation. Materials that appear dry on the surface can still be holding enough moisture to support mold growth within 24 to 48 hours. A professional moisture assessment after your initial cleanup is usually worth the cost to confirm nothing is hiding behind the walls."}, {"question": "What's the difference between water damage mitigation and water damage restoration?", "answer": "Mitigation is the emergency phase \u2014 stopping further damage, extracting water, and drying the structure. Restoration is the rebuild phase \u2014 replacing drywall, flooring, cabinets, and anything else that was removed or damaged. Some companies handle both under one contract; others specialize in one or the other. If your contractor handles mitigation only, you'll need a separate contractor for repairs, so clarify the full scope before work begins to avoid gaps in coverage or scheduling delays."}, {"question": "How long does mold remediation take, and will I need to leave my home?", "answer": "Timeline depends heavily on the size of the affected area and what materials are involved. A localized bathroom mold issue might be resolved in one to two days; a larger loss involving wall cavities or HVAC contamination can take a week or more. Whether you need to vacate depends on the remediation method, the size of the containment area, and whether any occupants have respiratory sensitivities \u2014 your remediator should give you a clear recommendation based on the specific job, not a blanket policy."}]
...
Your insurance company has an interest in paying as little as possible; a restoration company has an interest in billing as much as possible. Your interest is in getting your home back to pre-loss condition. Those three things don't always align.

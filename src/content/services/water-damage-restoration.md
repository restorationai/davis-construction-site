...
internal_links: ["/services/", "/contact/", "/service-areas/athens-al/water-damage-restoration/", "/service-areas/huntsville-al/water-damage-restoration/", "/service-areas/madison-al/water-damage-restoration/", "/blog/burst-pipe-emergency-checklist/", "/blog/what-to-do-first-24-hours-water-damage/", "/blog/choosing-a-restoration-company/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Services", "url": "/services/"}, {"name": "Water Damage Restoration"}]
faq: [{"question": "How long does structural drying typically take, and does the water category affect the timeline?", "answer": "A Category 1 (clean water) loss in a single room with good airflow typically dries in 3\u20135 days using commercial dehumidifiers and air movers. Category 2 losses \u2014 gray water from appliances or overflows \u2014 often run 4\u20137 days depending on how far moisture has migrated into wall assemblies or subfloor. Category 3 losses involving sewage or groundwater take longer because affected porous materials often need to be removed rather than dried in place, and antimicrobial treatment adds time to the process. Daily moisture readings, not a calendar, determine when drying is actually complete."}, {"question": "What's the difference between Category 1, Category 2, and Category 3 water, and why does it matter for cleanup?", "answer": "Category 1 is clean water from a supply line, rain intrusion through a roof, or a clean appliance overflow \u2014 it poses minimal health risk at the time of loss. Category 2 (gray water) includes discharge from washing machines, dishwashers, or toilet overflows without solid waste; it carries microorganisms and requires antimicrobial treatment of affected surfaces. Category 3 (black water) includes sewage, groundwater, and any water that has been standing long enough to support bacterial growth \u2014 it requires full PPE, specific disposal protocols, and typically removal of all porous materials it contacted. Misclassifying the water category is a genuine health and liability risk, not just a paperwork issue."}, {"question": "What should I do \u2014 and not do \u2014 while waiting for the restoration crew to arrive?", "answer": "If the water source is a supply line, shut off the main water valve immediately; if it's a roof or window intrusion, move valuables and electronics out of the affected area. Do not run a household fan over standing water \u2014 it moves contaminated air and doesn't meaningfully accelerate drying in a saturated structure. Avoid walking through sewage-category water without protective footwear, and don't use a standard wet-dry shop vac on Category 3 water. Take your own photos and video before anything is moved; that documentation supports your insurance claim even before our crew arrives."}, {"question": "Can wet hardwood floors be dried in place, or do they always need to come out?", "answer": "Hardwood can sometimes be dried in place using specialty drying mats that draw moisture directly through the surface, but the outcome depends on how long the floor was wet, the moisture content of the subfloor beneath it, and whether the boards have already begun to cup or buckle. If subfloor moisture readings are significantly elevated or the boards have visibly deformed, removal is usually the right call \u2014 leaving wet subfloor material in place is one of the most common causes of mold growth that surfaces weeks after a loss. We take daily readings and make that recommendation based on data, not assumption."}, {"question": "How does moisture documentation affect my insurance claim for water damage?", "answer": "Insurance adjusters reviewing a water damage claim want to see a clear record of where moisture was found, what equipment was deployed, and how readings changed over the drying period \u2014 this is what justifies the scope of work and the equipment rental line items on your claim. Without that documentation, adjusters often reduce or deny portions of the claim, particularly for structural drying and controlled demolition. We provide a full moisture log from day one through final clearance readings, which gives your adjuster the evidence they need to process the claim accurately."}]
...
**3. Water extraction**
High-capacity extractors remove standing water and pull moisture from carpet, pad, and porous flooring. Depending on the loss, we may recommend removing carpet pad — it holds water like a sponge and rarely dries in place without creating a mold risk beneath it.

**4. Structural drying with daily monitoring**
Air movers and dehumidifiers are placed according to a drying plan, not guesswork. We return daily to log moisture readings, adjust equipment placement, and document progress. Drying is complete when affected materials reach the target moisture content for your region's ambient conditions — not just when things feel dry to the touch.

**5. Controlled demolition if needed**
Sometimes drying in place isn't possible. Wet insulation, saturated drywall below the flood cut line, or swollen subfloor panels may need to come out to allow the structure to dry and to prevent hidden mold growth. We document everything removed for your insurance scope.
